...
import aboutusimg from "../header.jpg";
...
const aboutus = () => {
  return (
    <div class="aboutus-section">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="aboutus-banner">
              <aboutusimg src="header.jpg" rounded />
            </div>
          </div>
      ...
      <p>
        Donec vitae sapien ut libero venenatis faucibu. Nullam quis ante. Etiam
